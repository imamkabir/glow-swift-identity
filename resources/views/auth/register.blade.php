...
@section('title', 'Register - Neon Tech Enterprises')
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="glass border-2 border-neon-cyan/30 rounded-2xl p-8 animate-slide-in-up" style="animation-delay: 0.4s">
                ...
                <div class="flex mb-8 bg-white/5 rounded-lg p-1">
                    <a href="{{ route('login') }}" class="flex-1 py-2 rounded-md text-sm font-medium transition-all duration-300 text-gray-400 hover:text-white text-center">
                        Login
                    </a>
                    <div class="flex-1 py-2 rounded-md text-sm font-medium transition-all duration-300 neon-button-magenta text-center">
                        Register
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full neon-input rounded-lg px-4 py-3"
                    ...
                    <button
                        type="submit"
                        class="w-full neon-button-magenta py-3 rounded-lg text-lg font-medium transition-all duration-300"
                    >
                        Create Account
                    </button>
                </form>
                ...
                <div class="mt-8 text-center text-sm text-gray-400">
                    ...
                    <a href="{{ route('login') }}" class="text-neon-cyan hover:text-neon-magenta transition-colors">
                        Sign in
                    </a>
                </div>
            </div>
